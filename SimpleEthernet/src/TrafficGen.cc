...
//mi arrivano o timer di invio oppure pacchetti applicativi
void TrafficGen::handleMessage(cMessage *msg) {
    if(msg->isSelfMessage()) {
        if(strcmp(msg->getName(), "TxTimer") == 0) {
            //invio burst applicativo
            generate();
    ...
    //pkt arrivato non è quello atteso --> ho perso pacchetti
